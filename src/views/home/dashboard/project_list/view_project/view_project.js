                                    ...
                                    <div className="full counter_section margin_bottom_30">
                                        ...
                                        <div className="counter_no">
                                            <div>
                                                ...
                                                <p className="head_couter">Project Overview</p>
                                            </div>
                                        </div>
                                    </div>
                                </Link>
                                    ...
                                    <div className="full counter_section margin_bottom_30">
                                        ...
                                        <div className="counter_no">
                                            <div>
                                                ...
                                                <p className="head_couter">Project Walkthrough</p>
                                            </div>
                                        </div>
                                    </div>
                                </Link>
                                    ...
                                    <div className="full counter_section margin_bottom_30">
                                        ...
                                        <div className="counter_no">
                                            <div>
                                                ...
                                                <p className="head_couter">Project Amenities</p>
                                            </div>
                                        </div>
                                    </div>
                                </Link>
                                    ...
                                    <div className="full counter_section margin_bottom_30">
                                        ...
                                        <div className="counter_no">
                                            <div>
                                                ...
                                                <p className="head_couter">Project Floor Plan</p>
                                            </div>
                                        </div>
                                    </div>
                                </Link>
                                    ...
                                    <div className="full counter_section margin_bottom_30">
                                        ...
                                        <div className="counter_no">
                                            <div>
                                                ...
                                                <p className="head_couter">Project Gallery</p>
                                            </div>
                                        </div>
                                    </div>
                                </Link>
                                    ...
                                    <div className="full counter_section margin_bottom_30">
                                        ...
                                        <div className="counter_no">
                                            <div>
                                                ...
                                                <p className="head_couter">Project Location advantages</p>
                                            </div>
                                        </div>
                                    </div>
                                </Link>
                                    ...
                                    <div className="full counter_section margin_bottom_30">
                                        ...
                                        <div className="counter_no">
                                            <div>
                                                ...
                                                <p className="head_couter">Project RERA Details</p>
                                            </div>
                                        </div>
                                    </div>
                                </Link>
                                    ...
                                    <div className="full counter_section margin_bottom_30">
                                        ...
                                        <div className="counter_no">
                                            <div>
                                                ...
                                                <p className="head_couter">Project FAQs</p>
                                            </div>
                                        </div>
                                    </div>
                                </Link>
